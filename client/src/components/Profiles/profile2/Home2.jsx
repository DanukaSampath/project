...
function Home2() {
    ...
    useEffect(() => {
      axios
        .get('http://localhost:3001/profile2')
    ...
    const handleDelete = (id) => {
      axios
      .delete(`http://localhost:3001/profile2/delete/${id}`)
      .then((res) => {
        console.log(res);
    ...
    const handleCheckboxChange = (foodId) => {
      ...
      if (!isSelected) {
        ...
        axios.post('http://localhost:3001/profile2/saveSelectedFood', selectedFoodDetails)
          .then((res) => {
        ...
        if (storedObjectId) {
          axios.delete(`http://localhost:3001/profile2/deleteSelectedFood/${storedObjectId}`)
            .then((res) => {
    ...
    const handleClearTable = () => {
      axios.delete('http://localhost:3001/profile2/clearTable')
        .then((res) => {
