...
function Home7() {
  ...
  useEffect(() => {
    axios
      .get('http://localhost:3001/profile7')
  ...
  const handleDelete = (id) => {
    axios
    .delete(`http://localhost:3001/profile7/delete/${id}`)
    .then((res) => {
      console.log(res);
  ...
  const handleCheckboxChange = (foodId) => {
    ...
    if (!isSelected) {
      ...
      axios.post('http://localhost:3001/profile7/saveSelectedFood', selectedFoodDetails)
        .then((res) => {
      ...
      if (storedObjectId) {
        axios.delete(`http://localhost:3001/profile7/deleteSelectedFood/${storedObjectId}`)
          .then((res) => {
  ...
  const handleClearTable = () => {
    axios.delete('http://localhost:3001/profile7/clearTable')
      .then((res) => {
