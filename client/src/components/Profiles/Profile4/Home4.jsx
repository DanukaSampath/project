...
function Home4() {
  ...
  useEffect(() => {
    axios
      .get('http://localhost:3001/profile4')
  ...
  const handleDelete = (id) => {
    axios
    .delete(`http://localhost:3001/profile4/delete/${id}`)
    .then((res) => {
      console.log(res);
  ...
  const handleCheckboxChange = (foodId) => {
    ...
    if (!isSelected) {
      ...
      axios.post('http://localhost:3001/profile4/saveSelectedFood', selectedFoodDetails)
        .then((res) => {
      ...
      if (storedObjectId) {
        axios.delete(`http://localhost:3001/profile4/deleteSelectedFood/${storedObjectId}`)
          .then((res) => {
  ...
  const handleClearTable = () => {
    axios.delete('http://localhost:3001/profile4/clearTable')
      .then((res) => {
