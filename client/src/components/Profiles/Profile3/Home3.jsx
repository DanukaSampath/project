...
function Home3() {
  ...
  useEffect(() => {
    axios
      .get('http://localhost:3001/profile3')
  ...
  const handleDelete = (id) => {
    axios
    .delete(`http://localhost:3001/profile3/delete/${id}`)
    .then((res) => {
      console.log(res);
  ...
  const handleCheckboxChange = (foodId) => {
    ...
    if (!isSelected) {
      ...
      axios.post('http://localhost:3001/profile3/saveSelectedFood', selectedFoodDetails)
        .then((res) => {
      ...
      if (storedObjectId) {
        axios.delete(`http://localhost:3001/profile3/deleteSelectedFood/${storedObjectId}`)
          .then((res) => {
  ...
  const handleClearTable = () => {
    axios.delete('http://localhost:3001/profile3/clearTable')
      .then((res) => {
