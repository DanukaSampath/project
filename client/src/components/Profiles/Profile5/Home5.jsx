...
function Home5() {
  ...
  useEffect(() => {
    axios
      .get('http://localhost:3001/profile5')
  ...
  const handleDelete = (id) => {
    axios
    .delete(`http://localhost:3001/profile5/delete/${id}`)
    .then((res) => {
      console.log(res);
  ...
  const handleCheckboxChange = (foodId) => {
    ...
    if (!isSelected) {
      ...
      axios.post('http://localhost:3001/profile5/saveSelectedFood', selectedFoodDetails)
        .then((res) => {
      ...
      if (storedObjectId) {
        axios.delete(`http://localhost:3001/profile5/deleteSelectedFood/${storedObjectId}`)
          .then((res) => {
  ...
  const handleClearTable = () => {
    axios.delete('http://localhost:3001/profile5/clearTable')
      .then((res) => {
